...
def build_vae_var(
    ...
    # VAR args
    num_classes=10, depth=16, shared_aln=False, attn_l2_norm=True,
    ...
    var_wo_ddp = VAR(
        vae_local=vae_local,
        num_classes=num_classes, depth=depth, embed_dim=width, drop_rate=0., attn_drop_rate=0., drop_path_rate=dpr,
